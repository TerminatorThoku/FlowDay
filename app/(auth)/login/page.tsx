...
export default function LoginPage() {
  ...
  const handleGoogleSignIn = () => {
    // Placeholder: redirect to dashboard until Supabase is configured
    router.push("/");
  };
      ...
      <div className="flex w-full flex-col gap-4">
        ...
        <form onSubmit={handleMagicLink} className="flex w-full flex-col gap-3">
          ...
          <Button
            type="submit"
            variant="outline"
            className="h-12 w-full border-zinc-700 text-zinc-300 hover:bg-zinc-800 hover:text-zinc-100"
          >
